...
describe('Crypto Operations', () => {
  ...
  describe('*verifyDocumentSignature', () => {
    let data, key, publicKey, signature;
    beforeEach(() => {
      data = 'foo-data';
      key = generateKeys();
    ...
    describe('when the public key is wrong', () => {
      it('should return false', () => {
        ...
        expect(verifyDocumentSignature(data, signature, fakePublicKey)).toBe(
          false,
        );
      });
    });
    describe('when the public key has a wrong format', () => {
      it('should return an error', () => {
        ...
        const errorResponse =
          verifyDocumentSignature(data, signature, fakePublicKey) + '';
        expect(errorResponse.includes('Error to verify Document:')).toBe(true);
      });
    });
